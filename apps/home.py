...
layout = html.Div([
    dbc.Container([
        dbc.Row([
            dbc.Col(html.H1("The relation between the favourite - longshot bias\
            and the bookmaker's overround", className="text-center")
                    , className="mb-5 mt-5")
        ]),
        dbc.Row([
            dbc.Col(html.H5(children='The favourite - longshot bias is well \
        ...
        dbc.Row([
            dbc.Col(html.H5(children='The first page gives an overview of the literature. \
        ...
        dbc.Row([
            dbc.Col(dbc.Card(children=[html.H3(children='Get the original datasets used in this dashboard',
                                       ...
                                       dbc.Row([dbc.Col(dbc.Button("CSV files", href="https://www.football-data.co.uk/downloadm.php",
                                                                   color="primary"),
                                                        className="mt-3"),
                                                dbc.Col(dbc.Button("Database", href="https://andreas-masaoutis.github.io",
                                                                   color="primary"),
            ...
            dbc.Col(dbc.Card(children=[html.H3(children='Read the blog article detailing the process',
                                               className="text-center"),
                                       dbc.Button("My Blog",
